...
// Mitzi's name
console.log(Mitzi.name) // Mitzi

// Kennan's ID
console.log(Kennan.id)  // 2

// Keven's email
console.log(Keven.email) // kmummery2@wikimedia.org

// Gannie's name
console.log(Gannie.name) // Gannie
...
// Log the name and age of the grandchild
  console.log(`Name: ${parent.child.grandchild.name}, Age: ${parent.child.grandchild.age}`) // Name: Sam, Age: 30
